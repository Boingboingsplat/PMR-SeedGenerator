...
from maps.graph_edges.glitchless.edges_arn import edges_arn
from maps.graph_edges.glitchless.edges_dgb import edges_dgb
from maps.graph_edges.glitchless.edges_dro import edges_dro
from maps.graph_edges.glitchless.edges_flo import edges_flo
from maps.graph_edges.glitchless.edges_hos import edges_hos
from maps.graph_edges.glitchless.edges_isk import edges_isk
from maps.graph_edges.glitchless.edges_iwa import edges_iwa
from maps.graph_edges.glitchless.edges_jan import edges_jan
from maps.graph_edges.glitchless.edges_kgr import edges_kgr
from maps.graph_edges.glitchless.edges_kkj import edges_kkj
from maps.graph_edges.glitchless.edges_kmr import edges_kmr
from maps.graph_edges.glitchless.edges_kpa import edges_kpa
from maps.graph_edges.glitchless.edges_kzn import edges_kzn
from maps.graph_edges.glitchless.edges_mac import edges_mac
from maps.graph_edges.glitchless.edges_mgm import edges_mgm
from maps.graph_edges.glitchless.edges_mim import edges_mim
from maps.graph_edges.glitchless.edges_nok import edges_nok
from maps.graph_edges.glitchless.edges_obk import edges_obk
from maps.graph_edges.glitchless.edges_omo import edges_omo
from maps.graph_edges.glitchless.edges_osr import edges_osr
from maps.graph_edges.glitchless.edges_pra import edges_pra
from maps.graph_edges.glitchless.edges_sam import edges_sam
from maps.graph_edges.glitchless.edges_sbk import edges_sbk
from maps.graph_edges.glitchless.edges_tik import edges_tik
from maps.graph_edges.glitchless.edges_trd import edges_trd
...
def adjust(world_graph, new_edges=None, edges_to_remove=None):
    ...
    for new_edge in new_edges:
        ...
        if new_target_map_name is None or new_target_entrance_id is None:
            break
...
@overload
def check_unreachable_from_start(all_nodes:list, all_edges:list, do_print:bool) -> list:
    """Check if theres any nodes unreachable from KMR_20/4 (Mario's House Green Pipe)"""
    # build world graph
    if do_print:
        print("Generating world graph from nodes and edges ...")
    world_graph = generate(all_nodes, all_edges)
    return check_unreachable_from_start(world_graph, do_print)
